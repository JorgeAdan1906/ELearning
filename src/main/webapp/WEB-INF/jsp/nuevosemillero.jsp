...
<html>
    ...
    <body class="body1">
        ...
        <div id="divForm">
            <center>
                <form id="FormSem" method="POST" action="CrearActualizarSemillero.html">
                    ...
                    <input type="text" id="corre" placeholder="Correo electronico" required name="email">
                    <input type="text" id="con" placeholder="Contraseña" required name="contrasena">
                    ...
                    <div id="IdSem" style="display:none;">
                        <input type="text" id="semId" placeholder="Id" name="idUsuario">
                    </div>
                    <br>
                    <br>
                    <center>
                        <div id="DivBtnGuardar">
                            <div style="width: 60%">
                                <input class="submit" type="submit" onclick="alertGuardar()" value="Crear Usuario">
                            </div>  
                        </div>
                    ...
                    <tbody>
                        <c:forEach items="${semilleros}" var="semillero">
                            <tr>
                                ...
                                <td><c:out value="${semillero.contrasena}"></c:out></td>
                                <td><c:out value="${semillero.genero}"></c:out></td>
                                <td><c:out value="${semillero.rfc}"></c:out></td>
                                <td>
                                    <button type="button" class="btnbtn-danger" onClick="return confirm(${semillero.idUsuario})">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash " viewBox="0 0 16 16">
                                            <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                            <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                        </svg>
                                    </button>
                                    <button type="button" class="btnbtn-success" onClick="Editarr(this,${semillero.idUsuario})" >
        ...
        <script>
            ...
            function Editarr(td, id) {
                ...
                document.getElementById("corre").value = Fila.cells[3].innerHTML;
                document.getElementById("con").value = Fila.cells[4].innerHTML;
            ...
            function alertGuardar() {
                document.querySelector('#FormSem').addEventListener('submit', function (e) {

                    var form = this;
                    e.preventDefault();

                    swal.fire({
                        title: "¿Desea crear un nuevo Usuario?",
                        text: "",
                        icon: 'warning',
